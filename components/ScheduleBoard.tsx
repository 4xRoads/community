...
export function ScheduleBoard({ onCreateShift, shifts, onUpdateShift, onDeleteShift, onEditShift }: ScheduleBoardProps) {
  ...
  const [selectedDriverForVacation, setSelectedDriverForVacation] = useState('')
  ...
  const handleVacationClick = (driverName: string) => {
    setSelectedDriverForVacation(driverName)
  ...
  return (
    <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3 pb-4 border-b">
                <div className="flex space-x-2">
                  ...
                  />
                  <Button size="sm" onClick={handleAddDriver} className="h-8 px-3">
                  ...
                  <div key={driver.name} className="space-y-2">
                    ...
                    <div className="px-3">
                      <Button
                        ...
                        onClick={() => handleVacationClick(driver.name)}
                      >
      ...
      <VacationModal
        ...
        onOpenChange={setShowVacationModal}
        driverName={selectedDriverForVacation}
      />
    </div>
  )
}